...
const Dashboard = () => {
  ...
  return dashboardData ? (
    <div className='min-h-screen flex flex-col items-center justify-between gap-8 md:p-8 md:pb-0 pt-8 p-4 pb-0'>
                    ...
                    dashboardData.enrolledStudentsData.map((item, index) => (
                      <tr key={index} className='border-b border-gray-500/20'>
                        ...
                        <td className='md:px-4 py-3 px-2 flex items-center space-x-3'>
                          ...
                          <span className='text-center px-4 py-3'>{item.student.name}</span>
                        </td>
